<?php
  ...
  $id= $_GET['id'];
  $method = select_one_brands_controller($id);
                 ...
                 <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a class="nav-link btn" data-toggle="modal" data-target="#addProductModal" >Update Product</a>
                          ...
                          <input class="form-control" type="text" placeholder="Brand Name" name="brand_name" value="<?php echo $method[0]['brand_name']; ?>" >
				            <input class="form-control" type="hidden" placeholder="Brand Name" name="brand_id" value="<?php echo $method[0]['brand_id']; ?>" >
			              </div>
