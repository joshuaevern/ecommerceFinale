            ...
            <div class="card-body">
              ...
              <form action="../actions/registerprocess.php" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="user_role" id="user_role" class="form-control" placeholder="Your role" value="1">
                  </div>

                  <input type="submit" name="registerAdmin" class="btn btn-block login-btn mb-4" value="Sign Up">
                </form>
