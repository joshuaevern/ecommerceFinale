            ...
            <div class="card-body">
              ...
              <form action="../actions/loginprocess.php" method="POST">
                  ...
                  <div class="form-group mb-4">
                   ...
                   <input type="hidden" name="user_role" id="user_role" class="form-control" placeholder=1 hidden>
                  </div>
                 

                  <input type="submit" name="loginAdmin" class="btn btn-block login-btn mb-4" value="Login">
                </form>
               <!-- <a href="#!" class="forgot-password-link">Forgot password?</a>-->
                <p class="login-card-footer-text">Don't have an account? <a href="adminRegister.php" class="text-reset">Register here</a></p>
